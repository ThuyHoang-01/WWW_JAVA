        ...
        <div style="padding-top: 30px" class="panel-body">
          ...
          <form:form action="${pageContext.request.contextPath}/register/processRegistrationForm" modelAttribute="crmUser" class="form-horizontal">
            ...
            <div class="modal-footer">
              <a href="${pageContext.request.contextPath}/showMyLoginPage" class="btn btn-primary" role="button" aria-pressed="true" style="width: 77px; background-color: red">Cancel</a>
