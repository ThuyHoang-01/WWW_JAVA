...
<html lang="en">
  <head>
    ...
    <c:url var="pattern" value="/resources/img/nuochoa.jpg" />
    <style>
      * {
        margin: 0px auto;
        padding: 0px;
        ...
        <div class="panel-body">
          ...
          <form action="${pageContext.request.contextPath}/authenticateTheUser" method="POST" class="form-horizontal">
            ...
            <div class="form-group">
              <div class="col-xs-15">
                <div>
                  <!-- Ktra cho login error -->
                  <c:if test="${param.error != null}">
                    <div class="alert alert-danger col-xs-offset-1 col-xs-10"> Invalid user name and password. </div>
                  </c:if>
                  <!-- Ktra cho logout -->
